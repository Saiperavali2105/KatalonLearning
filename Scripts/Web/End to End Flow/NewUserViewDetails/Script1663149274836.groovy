...
WebUI.callTestCase(findTestCase('Web/End to End Flow/NewUserRegistration'), [('state') : 'KA', ('city') : 'Banglore', ('phone') : '1234567891'
        , ('email') : 'testngo2@gmail.com', ('ngoName') : 'TestNGO2'], FailureHandling.STOP_ON_FAILURE)
